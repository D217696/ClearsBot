#pragma checksum "C:\Users\Labra\OneDrive\Documenten\GitHub\ClearsBot\BotDashboard\Pages\Users\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d2503a2ec43bd8703a8aa1bc7c5bac59a8f30fa4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d2503a2ec43bd8703a8aa1bc7c5bac59a8f30fa4", @"/Pages/Users/Index.cshtml")]
    ...
    var app = new Vue({
       ...
       ");
        ...
        methods: {
            ...
            WriteLiteral(@"users.find(user => user.guid == guid);
            ...
            UpdateUser(){
                ...
                .then((data) => {
                    ...
                    {
               ");
            WriteLiteral(@"         this.GetUserList(this.activeUserBase.guid);
                    }
                });
            },
            LogMessage(message){
